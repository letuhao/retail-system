class Images {
    static Onboarding: string = 'https://images.unsplash.com/photo-1505995433366-e12047f3f144?fit=crop&w=840&q=80';
    static Pro: string = 'https://images.unsplash.com/photo-1485796826113-174aa68fd81b?fit=crop&w=840&q=80';

    static Products: { [key: string]: string } = {
        'Accessories': 'https://source.unsplash.com//l1MCA0VyNrk/840x840',
    };

    static Profile: string = 'https://images.unsplash.com/photo-1512529920731-e8abaea917a5?fit=crop&w=840&q=80';
    static Avatar: string = 'https://images.unsplash.com/photo-1518725522904-4b3939358342?fit=crop&w=210&q=80';
